...
export function AddCameraModal({
    ...
    if (
      ...
      const rtspUrl = `rtsp://${
        formData.username
          ...
          : ""
      }${formData.ip_address}:${formData.port}/live/cam/realmonitor?channel=${
        formData.channel
      }&subtype=0`;
  ...
  const testConnection = async () => {
    if (!formData.ip_address && formData.protocol !== "Yoosee") {
      setTestResult({
        success: false,
        message: "Vui lòng nhập địa chỉ IP trước khi test",
      });
      return;
    }
              ...
              <div key={step} className="flex items-center">
                ...
                <div
                  className={`ml-2 text-sm ${
                    step === currentStep ? "text-white" : "text-cyan-100"
                  }`}
                >
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    value={formData.type}
                    onChange={(e) =>
                      handleInputChange("type", e.target.value as "Vao" | "Ra")
                    }
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleInputChange("camera_brand", e.target.value)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                  >
                    {brands.map((brand) => (
              ...
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-lg p-4">
                <h4 className="font-medium text-blue-900 mb-3 flex items-center">
                  <span className="text-xl mr-2">�</span> Bắt đầu nhanh - Thông
                  tin cần thiết
                </h4>
                ...
                <div className="mt-3 pt-3 border-t border-blue-200">
                  <p className="text-xs text-blue-700">
                    <strong>💡 Mẹo:</strong> Camera Yoosee của bạn: Device ID{" "}
                    <strong>7804144881</strong>, IP{" "}
                    <strong>192.168.1.16</strong> - chỉ cần 2 thông tin này là
                    đủ!
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Xem trong app Yoosee → Settings → Device Info
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.port}
                    onChange={(e) =>
                      handleInputChange("port", parseInt(e.target.value) || 554)
                    }
                ...
                <div className="md:col-span-2 bg-blue-50 p-4 rounded-lg space-y-4">
                  ...
                  <div className="text-sm text-blue-800">
                    <p className="font-medium mb-1">
                      📱 Cách lấy Device ID từ app Yoosee:
                    </p>
                    <ol className="list-decimal list-inside space-y-1">
                      <li>Mở app Yoosee → chọn camera</li>
                      <li>
                        Vào Settings (⚙️) → Device Info (Thông tin thiết bị)
                      </li>
              ...
              {(formData.protocol === "RTSP" ||
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <h4 className="font-medium text-gray-900 mb-2">
                    Stream URLs{" "}
                    <span className="text-gray-400 text-xs">(tự động tạo)</span>
                  </h4>
                  <p className="text-sm text-yellow-800 mb-3">
                    ⚠️ URLs sẽ được tự động tạo dựa trên IP, Port và Protocol.
                    Bạn không cần điền thủ công.
                  </p>
                  ...
                  {formData.protocol === "RTSP" && formData.ip_address && (
                    <div className="bg-white p-3 rounded border border-yellow-300">
                      ...
                      <code className="text-xs text-gray-700 break-all">
                        ...
                        /live/cam/realmonitor?channel={formData.channel || 0}
                        &amp;subtype=0
                      </code>
                    </div>
                  )}
              ...
              {formData.protocol === "Yoosee" && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-blue-800">
                    Yoosee sử dụng protocol riêng. Chỉ cần Device ID và IP là
                    đủ. Hệ thống sẽ tự động kết nối qua app Yoosee hoặc P2P.
                  </p>
                </div>
              )}
              ...
              {formData.protocol === "ONVIF" && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-green-800">
                    ONVIF là chuẩn kết nối camera IP quốc tế. Hệ thống sẽ tự
                    động phát hiện stream URLs thông qua ONVIF Discovery.
                  </p>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.fps}
                    onChange={(e) =>
                      handleInputChange("fps", parseInt(e.target.value) || 30)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                    placeholder="30"
                    min="1"
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    📱 App Yoosee → Settings → Device Info
                    <br />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("onvif_id", e.target.value)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                    placeholder="Ví dụ: 2024DPP9340(M)"
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    🏷️ Xem trên tem camera (nếu có in sẵn)
                    <br />
                ...
                <div className="flex items-center space-x-4">
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("audio_enabled", e.target.checked)
                      }
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("main_stream_url", e.target.value)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("sub_stream_url", e.target.value)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
