        ...
        <div className="space-y-8">
            ...
            <div className="relative rounded-2xl p-8 text-white shadow-2xl overflow-hidden">
                ...
                <div className="relative z-10 flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold mb-2 drop-shadow-lg">Quản lý Camera</h1>
                        <p className="text-cyan-100 text-lg drop-shadow-md">Hệ thống nhận diện biển số - Đại học Đà Lạt</p>
                    </div>
                ...
                <div className="p-6">
                    ...
                    {selectedTab === "alerts" && (
                        <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
                                <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                                    <h2 className="text-xl font-semibold text-gray-900">Cảnh báo camera</h2>
                                </div>

                                <div className="p-6">
                                    <div className="space-y-4">
                                        {cameraAlerts.map((alert) => (
                                            <div key={alert.id} className="flex justify-between items-center p-6 border border-gray-200 rounded-2xl hover:shadow-lg transition-all duration-300">
                                                <div className="flex items-center space-x-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-gray-500 mt-2">Camera: {alert.camera} - {alert.time}</p>
                                                    </div>
                                                </div>
                                                <div className="flex space-x-3">
                                                    <span className={`inline-flex px-3 py-1 text-xs font-semibold rounded-full ${alert.priority === "Cao" ? "bg-red-100 text-red-800" :
                                                            alert.priority === "Trung bình" ? "bg-amber-100 text-amber-800" :
                    ...
                    {selectedTab === "settings" && (
                        <div className="space-y-6">
                            <div className="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
                                <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                                    <h2 className="text-xl font-semibold text-gray-900">Cài đặt nhận diện</h2>
                                </div>

                                <div className="p-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-6">
                                            <h3 className="text-lg font-semibold text-gray-900">Cấu hình camera</h3>
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                                    <span className="text-sm text-gray-700">Độ phân giải</span>
                                                    <select className="px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500">
                                                        <option>1080p</option>
                                                        <option>720p</option>
                                                        <option>480p</option>
                                                    </select>
                                                ...
                                                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                                    <span className="text-sm text-gray-700">Độ sáng</span>
                                                    <input type="range" min="0" max="100" defaultValue="50" className="w-32" />
                                                </div>
                                                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                                    <span className="text-sm text-gray-700">Độ tương phản</span>
                                                    <input type="range" min="0" max="100" defaultValue="50" className="w-32" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                                    <span className="text-sm text-gray-700">Lưu hình ảnh</span>
                                                    <button className="bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition-colors">Bật</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
